                        ...
                        <div className='col-12 col-md-4'>
                            <div className="pb-4 mb-4">
                                <p className='fonte-14 mt-4 mb-4'>
                                    As metas serão estabelecidas para os próximos cinco anos, a partir dos grupos formados considerando o <strong>Índice Sócio Econômico (INSE) e Indicador de Complexidade de Gestão (ICG)</strong>, levando em conta somente as escolas que compõem cada grupo, objetivando, assim, a diminuição da desigualdade dos resultados ao longo dos anos. Dessa maneira, as diferenças entre os resultados das escolas serão minimizadas dentro do grupo ao qual cada uma faz parte, como também, entre os grupos estabelecidos.
                                </p>
                            </div>
                        </div>
