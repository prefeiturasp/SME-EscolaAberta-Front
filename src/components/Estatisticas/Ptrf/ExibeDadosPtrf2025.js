  ...
  useEffect(()=>{
    ...
    if (escola && escola.length > 0){
      setDadosDaEscolaPtrf({
        ...
        DRE: escola[0].DRE,
        REP_1_VALOR_CALCULADO: escola[0].REP_1_VALOR_CALCULADO,
        REP_1_VALOR_ADICIONAL_ALUNO: escola[0].REP_1_VALOR_ADICIONAL_ALUNO,
        REP_1_VALOR_TOTAL: escola[0].REP_1_VALOR_TOTAL,
        REP_2_VALOR_CALCULADO: escola[0].REP_2_VALOR_CALCULADO,
        REP_2_VALOR_ADICIONAL_ALUNO: escola[0].REP_2_VALOR_ADICIONAL_ALUNO,
        REP_2_VALOR_GREMIO: escola[0].REP_2_VALOR_GREMIO,
        REP_2_VALOR_TOTAL: escola[0].REP_2_VALOR_TOTAL,
        REP_3_VALOR_CALCULADO: escola[0].REP_3_VALOR_CALCULADO,
        REP_3_VALOR_ADICIONAL_ALUNO: escola[0].REP_3_VALOR_ADICIONAL_ALUNO,
        REP_3_VALOR_TOTAL: escola[0].REP_3_VALOR_TOTAL,
